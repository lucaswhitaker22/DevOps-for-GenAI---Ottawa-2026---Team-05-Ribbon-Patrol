    ...
    switch (level) {
      ...
      case 'Blocked':
        return {
          ...
          barBg: 'bg-orange-500',
          badgeBg: 'bg-orange-50 dark:bg-orange-950/80 text-orange-800 dark:text-orange-300 border-orange-200 dark:border-orange-800',
          icon: ShieldAlert,
      ...
      case 'Unsafe':
        return {
          ...
          barBg: 'bg-rose-500',
          badgeBg: 'bg-rose-50 dark:bg-rose-950/80 text-rose-800 dark:text-rose-300 border-rose-200 dark:border-rose-800 ring-2 ring-rose-300 dark:ring-rose-800 animate-pulse',
          icon: ShieldAlert,
  ...
  return (
    <div className="space-y-3.5">
      ...
      <div
        ...
        className="relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900/90 border border-slate-200/90 dark:border-slate-800 p-4 shadow-xs transition-all flex flex-col items-center select-none"
      ...
      >
        ...
        <div className="w-full flex items-center justify-between gap-2 z-20 pb-1">
          ...
          <button
            ...
            className="flex items-center gap-2 px-2.5 py-1 rounded-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors cursor-pointer"
            title="Click to inspect Repository Health Breakdown"
          >
            <span className="text-[10px] font-mono font-bold text-slate-500 dark:text-slate-400">HP</span>
            ...
            <span className="font-mono text-xs font-bold text-slate-800 dark:text-slate-100">{state.healthPercentage}%</span>
          </button>
        </div>
        ...
        <div className="text-center max-w-md mt-1">
          <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100 flex items-center justify-center gap-1.5">
            {state.symptomTitle}
          </h2>
        ...
        {/* Action Dock */}
        <div className="w-full flex items-center justify-between gap-1.5 pt-3 mt-2 border-t border-slate-100 dark:border-slate-800">
          <div className="flex items-center gap-1 flex-wrap">
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-rose-50 dark:hover:bg-rose-950/40 hover:text-rose-600 dark:hover:text-rose-300 text-slate-600 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700 text-[11px] font-semibold flex items-center gap-1 transition-all active:scale-95 cursor-pointer shadow-2xs"
            >
              <span>🐾</span>
              <span>Pet</span>
            </button>
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-amber-50 dark:hover:bg-amber-950/40 hover:text-amber-700 dark:hover:text-amber-300 text-slate-600 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700 text-[11px] font-semibold flex items-center gap-1 transition-all active:scale-95 cursor-pointer shadow-2xs"
            >
              <span>☕</span>
              <span>Fuel</span>
            </button>
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 hover:text-indigo-600 dark:hover:text-indigo-300 text-slate-600 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700 text-[11px] font-semibold flex items-center gap-1 transition-all active:scale-95 cursor-pointer shadow-2xs"
            >
              <span>🎩</span>
              <span>Outfit</span>
            </button>
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-blue-50 dark:hover:bg-blue-950/40 hover:text-blue-600 dark:hover:text-blue-300 text-slate-600 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700 text-[11px] font-semibold flex items-center gap-1 transition-all active:scale-95 cursor-pointer shadow-2xs"
            >
              <span>💬</span>
              <span>Ask</span>
            </button>
          ...
          <div className="flex items-center gap-1 text-[10px] font-mono text-slate-400">
            <kbd className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded font-semibold text-slate-600 dark:text-slate-300">
              Space
            </kbd>
      ...
      <div className="grid grid-cols-2 gap-2.5">
        ...
        <button
          ...
          className="text-left p-3.5 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/90 dark:border-slate-800 shadow-xs hover:border-indigo-300 dark:hover:border-indigo-700 hover:bg-slate-50 dark:hover:bg-slate-800/80 transition-all cursor-pointer group flex flex-col justify-between"
        >
          <div className="flex items-center justify-between w-full">
            ...
            <span className="text-[10px] font-mono font-bold text-slate-400 dark:text-slate-500 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 flex items-center gap-0.5">
              DAG <ChevronRight className="w-3 h-3" />
            </span>
          </div>
          <div className="mt-2">
            <span className="text-[11px] font-bold text-slate-800 dark:text-slate-100 block truncate">Branch Drift & Tree</span>
            <div className="flex items-center gap-2 mt-0.5 font-mono text-xs">
              <span className={state.currentBranch.aheadCount > 0 ? 'text-indigo-600 dark:text-indigo-400 font-bold' : 'text-slate-500 dark:text-slate-400'}>
                ↑{state.currentBranch.aheadCount} ahead
              </span>
              <span className="text-slate-300 dark:text-slate-600">|</span>
              <span className={state.currentBranch.behindCount > 0 ? 'text-amber-600 dark:text-amber-400 font-bold' : 'text-slate-500 dark:text-slate-400'}>
        ...
        <button
          ...
          className="text-left p-3.5 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/90 dark:border-slate-800 shadow-xs hover:border-amber-300 dark:hover:border-amber-700 hover:bg-slate-50 dark:hover:bg-slate-800/80 transition-all cursor-pointer group flex flex-col justify-between"
        >
          <div className="flex items-center justify-between w-full">
            <div className="p-1.5 rounded-lg bg-amber-50 dark:bg-amber-950/60 text-amber-600 dark:text-amber-400 group-hover:scale-105 transition-transform">
              <Zap className="w-4 h-4" />
            </div>
            <span className="text-[10px] font-mono font-bold text-slate-400 dark:text-slate-500 group-hover:text-amber-600 dark:group-hover:text-amber-400 flex items-center gap-0.5">
              CI/CD <ChevronRight className="w-3 h-3" />
            </span>
          </div>
          <div className="mt-2">
            <span className="text-[11px] font-bold text-slate-800 dark:text-slate-100 block truncate">Pipeline & Tests</span>
        ...
        <button
          ...
          className="text-left p-3.5 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/90 dark:border-slate-800 shadow-xs hover:border-purple-300 dark:hover:border-purple-700 hover:bg-slate-50 dark:hover:bg-slate-800/80 transition-all cursor-pointer group flex flex-col justify-between"
        >
          <div className="flex items-center justify-between w-full">
            <div className="p-1.5 rounded-lg bg-purple-50 dark:bg-purple-950/60 text-purple-600 dark:text-purple-400 group-hover:scale-105 transition-transform">
              <GitPullRequest className="w-4 h-4" />
            </div>
            <span className="text-[10px] font-mono font-bold text-slate-400 dark:text-slate-500 group-hover:text-purple-600 dark:group-hover:text-purple-400 flex items-center gap-0.5">
          ...
          <div className="mt-2">
            ...
            <span className="text-[11px] text-purple-700 dark:text-purple-300 font-semibold block mt-0.5 capitalize">
        ...
        <button
          ...
          className="text-left p-3.5 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/90 dark:border-slate-800 shadow-xs hover:border-emerald-300 dark:hover:border-emerald-700 hover:bg-slate-50 dark:hover:bg-slate-800/80 transition-all cursor-pointer group flex flex-col justify-between"
        >
          <div className="flex items-center justify-between w-full">
            ...
            <span className="text-[10px] font-mono font-bold text-slate-400 dark:text-slate-500 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 flex items-center gap-0.5">
              Gate <ChevronRight className="w-3 h-3" />
            </span>
          </div>
          <div className="mt-2">
            <span className="text-[11px] font-bold text-slate-800 dark:text-slate-100 block truncate">Release Gate</span>
            <div className="flex items-center gap-1.5 mt-0.5">
              <span className="text-xs font-black font-mono text-slate-900 dark:text-slate-100">{readiness.overallScore}%</span>
              <span className={`text-[10px] font-bold ${readiness.canShip ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'}`}>
                {readiness.canShip ? 'Ship Ready' : 'Blockers'}
              </span>
            </div>
            <span className="text-[10px] text-slate-400 dark:text-slate-500 block mt-0.5 font-mono">5-Pillar Sign-off</span>
          </div>
        </button>
      </div>
    </div>
