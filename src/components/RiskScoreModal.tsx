        ...
        >
          ...
          <div className="p-5 sm:p-6 overflow-y-auto space-y-6">
            ...
            <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-5">
              <div className="flex items-center gap-4">
                ...
                <div className="relative w-20 h-20 shrink-0 flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-xl font-black text-slate-900 font-mono">{breakdown.overallScore}</span>
              ...
              <div className="text-right sm:border-l sm:border-slate-200 sm:pl-5 text-xs text-slate-500 shrink-0">
                <div className="font-semibold text-slate-700">Health Level</div>
                <div className="text-sm font-bold text-slate-900 capitalize">{breakdown.healthLevel}</div>
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-xs text-slate-600 truncate mt-0.5">{factor.details}</p>
                          </div>
                        </div>
                      ...
                      {isSelected && (
                        <motion.div
                          ...
                          className="mt-3 pt-3 border-t border-slate-200/80 space-y-2.5"
                        >
                          <div className="p-3 bg-white rounded-xl border border-slate-200 text-xs space-y-1">
                            <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400 block">
                              Diagnostic Finding
                            </span>
                            <p className="text-slate-800 font-medium">{factor.details}</p>
                          </div>

                          <div className="p-3 bg-indigo-50/70 rounded-xl border border-indigo-200 text-xs flex items-center justify-between gap-3">
                            <div className="space-y-0.5">
                              <span className="text-[11px] font-bold text-indigo-900 flex items-center gap-1">
                                <Sparkles className="w-3 h-3 text-indigo-600" />
                                Recommended Remediation
                              </span>
                              <p className="text-indigo-800 text-[11px] font-medium">{factor.recommendation}</p>
                            </div>
